    ...
    <div className="space-y-6">
      {!file ? (
        <div
          ...
          onClick={() => { const input = document.createElement("input"); input.type = "file"; input.accept = ".xlsx,.xls"; input.onchange = () => input.files?.[0] && loadFile(input.files[0]); input.click(); }}
