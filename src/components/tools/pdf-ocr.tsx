...
export function PdfOcr() {
  ...
  const { open: openFileDialog, inputProps: fileInputProps } = useFileInput({ accept: ".pdf,image/*", onFile: (file) => loadFile(file) });
    ...
    <div className="space-y-6">
      ...
      {!file ? (
        <>
          ...
          >
            <Scan size={48} weight="duotone" className="mx-auto mb-3 text-muted-foreground" />
        ...
        <div className="space-y-4">
          <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-xs text-muted-foreground">{resultText.length} {t("chars")}</span>
            </div>
