...
export const tools: Tool[] = [
  ...
  { id: 'base64', slug: 'base64', category: 'security', icon: 'Binary', isAvailable: true, isPremium: false, maxFileSize: 10 * 1024 * 1024, acceptedFormats: [], processingType: 'none' },
  ...
  { id: 'password-generator', slug: 'password-generator', category: 'security', icon: 'Key', isAvailable: true, isPremium: false, maxFileSize: 0, acceptedFormats: [], processingType: 'none' },
  { id: 'hash-generator', slug: 'hash-generator', category: 'security', icon: 'Fingerprint', isAvailable: true, isPremium: false, maxFileSize: 0, acceptedFormats: [], processingType: 'none' },
  { id: 'uuid-generator', slug: 'uuid-generator', category: 'security', icon: 'Shuffle', isAvailable: true, isPremium: false, maxFileSize: 0, acceptedFormats: [], processingType: 'none' },
  { id: 'jwt-decoder', slug: 'jwt-decoder', category: 'security', icon: 'ShieldCheck', isAvailable: true, isPremium: false, maxFileSize: 0, acceptedFormats: [], processingType: 'none' },
  { id: 'password-strength-checker', slug: 'password-strength', category: 'security', icon: 'ShieldCheck', isAvailable: true, isPremium: false, maxFileSize: 0, acceptedFormats: [], processingType: 'none' },
  { id: 'hmac-generator', slug: 'hmac-generator', category: 'security', icon: 'Fingerprint', isAvailable: true, isPremium: false, maxFileSize: 0, acceptedFormats: [], processingType: 'none' },
  { id: 'aes-encrypt-decrypt', slug: 'aes-encrypt', category: 'security', icon: 'LockSimple', isAvailable: true, isPremium: false, maxFileSize: 0, acceptedFormats: [], processingType: 'none' },
  { id: 'crc32-checker', slug: 'crc32', category: 'security', icon: 'Hash', isAvailable: true, isPremium: false, maxFileSize: 0, acceptedFormats: [], processingType: 'none' },
  { id: 'credit-card-validator', slug: 'credit-card-validator', category: 'security', icon: 'CreditCard', isAvailable: true, isPremium: false, maxFileSize: 0, acceptedFormats: [], processingType: 'none' },
  { id: 'totp-generator', slug: 'totp-generator', category: 'security', icon: 'Timer', isAvailable: true, isPremium: false, maxFileSize: 0, acceptedFormats: [], processingType: 'none' },
  { id: 'rsa-key-generator', slug: 'rsa-key-generator', category: 'security', icon: 'Key', isAvailable: true, isPremium: false, maxFileSize: 0, acceptedFormats: [], processingType: 'none' },
